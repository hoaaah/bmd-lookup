...
/**
 * TaKibESearch represents the model behind the search form about `app\models\TaKibE`.
 */
class TaKibESearch extends TaKibE
{
    ...
    {
        return [
            [['IDPemda', 'Kd_Prov', 'kodeUnit', 'Kd_Kab_Kota', 'Kd_Bidang', 'Kd_Aset1', 'Kd_Aset2', 'Kd_Aset3', 'Kd_Aset4', 'Kd_Aset5', 'Kd_Pemilik', 'Asal_usul', 'Kondisi', 'Keterangan', 'No_SP2D', 'Tgl_Pembukuan', 'Invent', 'No_SKGuna', 'Kd_Penyusutan', 'Kd_Data', 'Log_User', 'Log_entry', 'Kd_Masalah', 'Ket_Masalah', 'No_SIPPT', 'kodeAset'], 'safe'],
            [['Kd_Unit', 'Kd_Sub', 'Kd_UPB', 'No_Register', 'Masa_Manfaat', 'Tahun', 'No_ID', 'Kd_Kecamatan', 'Kd_Desa', 'Kd_KA', 'Dev_Id', 'Kd_Hapus'], 'integer'],

...
/**
 * This is the model class for table "Ta_KIB_E".
 *
 ...
 *
 * @property TaFotoE[] $taFotoEs
 * @property RefRekAset5 $kdAset5
 * @property RefPemda $kdKabKota
 * @property RefUPB $kdUPB
 * @property TaKIBEHapus $taKIBEHapus
 * @property TaKIBER[] $taKIBERs
 * @property TaSusutE[] $taSusutEs
 */
class TaKibE extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['IDPemda', 'Judul', 'Pencipta', 'Bahan', 'Ukuran', 'Asal_usul', 'Kondisi', 'Keterangan', 'No_SP2D', 'No_SKGuna', 'Log_User', 'No_SIPPT'], 'string'],
            [['Kd_Prov', 'Kd_Kab_Kota', 'Kd_Bidang', 'Kd_Unit', 'Kd_Sub', 'Kd_UPB', 'Kd_Aset1', 'Kd_Aset2', 'Kd_Aset3', 'Kd_Aset4', 'Kd_Aset5', 'No_Register', 'Kd_Ruang', 'Kd_Pemilik', 'Masa_Manfaat', 'Tahun', 'No_ID', 'Kd_Kecamatan', 'Kd_Desa', 'Invent', 'Kd_Penyusutan', 'Kd_Data', 'Kd_KA', 'Dev_Id', 'Kd_Hapus'], 'integer'],
     ...
     */
    public function getTaFotoEs()
    {
        return $this->hasMany(TaFotoE::className(), ['IDPemda' => 'IDPemda']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getTaKIBEHapus()
    {
        return $this->hasOne(TaKIBEHapus::className(), ['IDPemda' => 'IDPemda']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTaKIBERs()
    {
        return $this->hasMany(TaKIBER::className(), ['IDPemda' => 'IDPemda']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTaSusutEs()
    {
        return $this->hasMany(TaSusutE::className(), ['IDPemda' => 'IDPemda']);
    }
}

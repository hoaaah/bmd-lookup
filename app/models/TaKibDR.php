...
/**
 * This is the model class for table "Ta_KIBDR".
 *
 ...
 * @property int $Dev_ID
 *
 * @property TaKIBD $pemda
 */
class TaKibDR extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['IDPemda', 'No_Dokumen', 'Konstruksi', 'Lokasi', 'Dokumen_Nomor', 'Status_Tanah', 'Asal_usul', 'Kondisi', 'Keterangan', 'No_SP2D', 'No_SKGuna', 'Log_User', 'Nm_Rekanan', 'Alamat_Reakanan', 'Kd_Koreksi'], 'string'],
            ...
            [['IDPemda'], 'exist', 'skipOnError' => true, 'targetClass' => TaKIBD::className(), 'targetAttribute' => ['IDPemda' => 'IDPemda']],
        ];
    }
    ...
    {
        return $this->hasOne(TaKIBD::className(), ['IDPemda' => 'IDPemda']);
    }

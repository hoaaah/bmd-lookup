...
/**
 * This is the model class for table "Ta_KIBER".
 *
 ...
 * @property int $Dev_ID
 *
 * @property TaKIBE $pemda
 */
class TaKibER extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['IDPemda', 'No_Dokumen', 'Judul', 'Pencipta', 'Bahan', 'Asal_usul', 'Kondisi', 'Keterangan', 'No_SP2D', 'No_SKGuna', 'Log_User', 'Nm_Rekanan', 'Alamat_Reakanan', 'Kd_Koreksi'], 'string'],
            ...
            [['Ukuran', 'Harga', 'Nilai_Sisa'], 'number'],
            [['IDPemda', 'Kd_Id'], 'unique', 'targetAttribute' => ['IDPemda', 'Kd_Id']],
            [['IDPemda'], 'exist', 'skipOnError' => true, 'targetClass' => TaKIBE::className(), 'targetAttribute' => ['IDPemda' => 'IDPemda']],
        ];
    }
    ...
    {
        return $this->hasOne(TaKIBE::className(), ['IDPemda' => 'IDPemda']);
    }
